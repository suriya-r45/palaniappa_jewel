  ...
  private initializeProducts() {
    ...
    const goldProducts: InsertProduct[] = [
      {
        ...
        weight: "25g",
        stockQuantity: 5,
        imageUrls: ["https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=300"],
        isFeatured: true,
      },
      {
        ...
        weight: "12g",
        stockQuantity: 8,
        imageUrls: ["https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=300"],
        isFeatured: true,
      },
      {
        ...
        weight: "15g",
        stockQuantity: 3,
        imageUrls: ["https://images.unsplash.com/photo-1611591437281-460bfbe1220a?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=300"],
        isFeatured: true,
      },
      {
        ...
        weight: "8g",
        stockQuantity: 6,
        imageUrls: ["https://images.unsplash.com/photo-1605100804763-247f67b3557e?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=300"],
        isFeatured: true,
      },
      {
    ...
    const silverProducts: InsertProduct[] = [
      {
        ...
        weight: "18g",
        stockQuantity: 12,
        imageUrls: ["https://images.unsplash.com/photo-1611652022419-a9419f74343d?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=300"],
        isFeatured: true,
      },
      {
        ...
        weight: "8g",
        stockQuantity: 20,
        imageUrls: ["https://images.unsplash.com/photo-1617038260897-41a1f14a8ca0?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=300"],
        isFeatured: true,
      },
      {
    ...
    const diamondProducts: InsertProduct[] = [
      {
        ...
        weight: "15g",
        stockQuantity: 3,
        imageUrls: ["https://images.unsplash.com/photo-1602173574767-37ac01994b2a?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=300"],
        isFeatured: true,
      },
      {
    ...
    const newArrivalProducts: InsertProduct[] = [
      ...
      },
      {
        ...
        description: "Set of three stackable 14K gold rings with different textures",
        category: "new-arrivals",
        priceInr: "32000",
        priceBhd: "160",
        weight: "9g",
      ...
      {
        name: "Art Deco Silver Earrings",
        description: "Vintage-inspired art deco design in sterling silver",
        category: "new-arrivals",
        priceInr: "11500",
        priceBhd: "57",
        weight: "12g",
      ...
      },
      {
        ...
        description: "Modern geometric pendant with diamond accent in rose gold",
        category: "new-arrivals",
        priceInr: "85000",
        priceBhd: "425",
        weight: "7g",
      ...
      {
        name: "Boho Silver Arm Cuff",
        description: "Bohemian-style silver arm cuff with intricate patterns",
        category: "new-arrivals",
        priceInr: "13500",
        priceBhd: "67",
        weight: "25g",
      ...
      },
      {
        ...
        description: "Delicate infinity symbol bracelet in 18K yellow gold",
        category: "new-arrivals",
        priceInr: "26500",
        priceBhd: "132",
        weight: "8g",
      ...
      {
        name: "Contemporary Pearl Earrings",
        description: "Modern pearl earrings with silver wire design",
        category: "new-arrivals",
        priceInr: "18500",
        priceBhd: "92",
        weight: "6g",
    ...
    [...goldProducts, ...silverProducts, ...diamondProducts, ...newArrivalProducts].forEach(productData => {
      const id = randomUUID();
